...
class Form extends Component {
	...
	render() {
		let {email, password, rpassword, register, advertiser, publisher, agency, nameAndLast, mobileNo, sex, male, female, legalName, phone} = this.props;
		...
		return (
			<form className="login-form" onSubmit={handleSubmit(this.submit)}>
				...
				<div className="row">
					...
					<div className="col-xs-6">
						<div className="form-group form-md-line-input">
							<select className="form-control" name="delivery" aria-required="true" aria-describedby="delivery-error" aria-invalid="false">
