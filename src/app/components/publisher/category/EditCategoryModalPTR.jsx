...
class EditCategoryModalPTR extends Component {
	...
	render() {
		...
		return (
			<div className="edit-category-modal modal fade fullscreen" id="editCategoryModal" tabIndex="-1"
				 role="dialog"
						...
						<div className="modal-body text-center">
							<div className="col-md-4 col-md-offset-4">
								...
								<form role="form" action="" method="post" id="editCategoryForm"
									  className="add-category-form white"
									  onSubmit={handleSubmit((values) => SubmitEditCategory(values, this.editCategoryForm))}>
									...
									<button type="submit"
											className="edit-category-form btn btn-primary btn-lg btn-block">ذخیره
									</button>
								</form>
							</div>
						</div>
