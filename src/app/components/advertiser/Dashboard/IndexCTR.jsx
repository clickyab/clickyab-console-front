                    ...
                    <div className="col-lg-5">
                        <div className="row">
                            <div className="col-sm-6 col-lg-6">
                                    <div className="panel panel-success panel-colorful dashboard-stat dashboard-stat-v2 blue">
                                        <div className="dashboard-stat2 ">
                                        <div className="pad-all">
                                            <p className="text-lg text-semibold"><i className="demo-pli-data-storage icon-fw fa fa-gears"/> کمپین ها</p>
                                            <p>
                            ...
                            <div className="col-sm-6 col-lg-6">
                                <div className="panel panel-success panel-colorful dashboard-stat dashboard-stat-v2 purple">
                                    <div className="dashboard-stat2 ">
                                        <div className="pad-all">
                                            <p className="text-lg text-semibold"><i className="demo-pli-data-storage icon-fw fa fa-bullseye"/> کلیک ها</p>
                                            <p>
                        ...
                        <div className="row">
                            <div className="col-sm-6 col-lg-6">
                                <div className="panel panel-success panel-colorful dashboard-stat dashboard-stat-v2 red">
                                    <div className="dashboard-stat2 ">
                                        <div className="pad-all">
                                            <p className="text-lg text-semibold"><i className="demo-pli-data-storage icon-fw fa fa-gears"/> تبلیغات</p>
                                            <p>
                            ...
                            <div className="col-sm-6 col-lg-6">
                                <div className="panel panel-success panel-colorful dashboard-stat dashboard-stat-v2 green">
                                    <div className="dashboard-stat2 ">
                                        <div className="pad-all">
                                            <p className="text-lg text-semibold"><i className="demo-pli-data-storage icon-fw fa fa-gears"/>  بوجه </p>
                                            <p>
