                        ...
                        <div className="modal-body text-center">
                            <div className="col-md-4 col-md-offset-4">
                                ...
                                <form role="form" action="" id="WithDrawForm" method="post"
                                    ...
                                    <blockquote>
                                        <p style={{color: 'gray'}}>مبلغ مورد نظر برای برداشت از حساب‌کاربری‌تان را وارد نمایید.</p>
                                        <p style={{color: 'gray'}}>حداقل مبلغ قابل برداشت 50 هزار تومان است و پس از تایید نهایی فقط در روزهای 5 و 20 هر ماه برایتان واریز خواهد شد.</p>
                                    </blockquote>
                                    <button type="submit"
