    ...
    src(src, {description}) {
        ...
        if (src != null) {
            if (splitByLastDot(src) == "png" || splitByLastDot(src) == "jpg") {
                ...
                return <img className={ "thumbnail-image"} src="/img/pdf-file.jpg" data-caption={Base64.decode(description)}/>
            }

        } else {
            return <img className={ "thumbnail-image"} src="/img/thumbnail.jpg" data-caption={Base64.decode(description)}/>
        }
