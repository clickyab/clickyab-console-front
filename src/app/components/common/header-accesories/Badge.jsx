						...
						<ul className="dropdown-menu-list scroller" style={{height: 275 + 'px'}}
							...
							<li>
								<a href="javascript:;">
                                                                    <span className="task">
                                                                        <span
																			className="desc">Application deployment</span>
									...
									<span className="progress">
                                                                        <span style={{width: 65 + '%'}}
																			  ...
																			  aria-valuemax="100">
                                                                            <span
																				className="sr-only">65% Complete</span>
                                                                        </span>
                                                                    </span>
								</a>
							</li>
								...
								<a href="javascript:;">
									...
									<span className="progress">
                                                                        <span style={{width: 98 + '%'}}
																			  ...
																			  aria-valuemax="100">
                                                                            <span
																				className="sr-only">98% Complete</span>
                                                                        </span>
                                                                    </span>
								</a>
							</li>
								...
								<a href="javascript:;">
									...
									<span className="progress">
                                                                        <span style={{width: 10 + '%'}}
																			  ...
																			  aria-valuemax="100">
                                                                            <span
																				className="sr-only">10% Complete</span>
                                                                        </span>
                                                                    </span>
								</a>
							</li>
								...
								<a href="javascript:;">
									...
									<span className="progress">
                                                                        <span style={{width: 58 + '%'}}
																			  ...
																			  aria-valuemax="100">
                                                                            <span
																				className="sr-only">58% Complete</span>
                                                                        </span>
                                                                    </span>
								</a>
							</li>
								...
								<a href="javascript:;">
									...
									<span className="progress">
                                                                        <span style={{width: 85 + '%'}}
																			  ...
																			  aria-valuemax="100">
                                                                            <span
																				className="sr-only">85% Complete</span>
                                                                        </span>
                                                                    </span>
								</a>
							</li>
								...
								<a href="javascript:;">
									...
									<span className="progress progress-striped">
                                                                        <span style={{width: 38 + '%'}}
																			  ...
																			  aria-valuemax="100">
                                                                            <span
																				className="sr-only">38% Complete</span>
                                                                        </span>
                                                                    </span>
								</a>
							</li>
