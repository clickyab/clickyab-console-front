		...
		return (
			<li className="dropdown dropdown-extended dropdown-notification dropdown-dark" id="header_notification_bar">
				...
				<ul className="dropdown-menu">
					...
					<li>
						<ul className="dropdown-menu-list scroller" style={{height: 250 + 'px'}}
							...
							<li>
								<a href="javascript:;">
									...
									<span className="details">
                                                                        <span
																			className="label label-sm label-icon label-danger">
							...
							<li>
								<a href="javascript:;">
									...
									<span className="details">
                                                                        <span
																			className="label label-sm label-icon label-warning">
							...
							<li>
								<a href="javascript:;">
									...
									<span className="details">
                                                                        <span
																			className="label label-sm label-icon label-info">
