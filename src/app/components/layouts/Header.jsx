                ...
                <div className="page-header-inner ">
                    ...
                    <div className="top-menu pull-right user-type">
                        <ul className="nav navbar-nav pull-right">
                            <li className="dropdown dropdown-user ">
                                <a href="javascript:;" className="dropdown-toggle active" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    <i className="fa fa-bullhorn"/>
                                    <span className="username username-hide-on-mobile"> نمایش دهنده </span>
                                </a>
                            </li>
                            <li className="dropdown dropdown-user open">
                    ...
                    <div className="top-menu">
                        ...
                        <ul className="nav navbar-nav pull-right">
                            ...
                            <li className="dropdown dropdown-user">
                                <a href="javascript:;" className="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    <img alt="" className="img-circle" src="/img/avatar3_small.jpg" />
                                    <span className="username username-hide-on-mobile"> سلام میلاد حیدری </span>
                                    <i className="fa fa-angle-down"/>
                                </a>
                                <ul className="dropdown-menu dropdown-menu-default">
                                    <li>
                                        <a href="page_user_profile_1.html">
                                            <i className="icon-user"/>ویرایش کاربری </a>
                                    </li>
                                    <li>
                                        <a href="app_calendar.html">
                                            <i className="icon-calendar"/> تغییر کلمه عبور </a>
                                    </li>
                                    <li>
                                        <a href="app_inbox.html">
                                            <i className="icon-envelope-open"/> صورت حساب
