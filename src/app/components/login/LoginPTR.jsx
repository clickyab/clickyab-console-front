...
class LoginForm extends Component {
	...
	render() {
		...
		let {login, email, password, login_with_google, forgot_password, or_login_with , to_reset_your_password , login_to_your_account ,  do_not_have_an_account_yet ,  click , here ,   create_account, submit} = this.props;
		const { handleSubmit} = this.props;
		const Submit = this.props.SubmitCall(this.form);
		return (
			...
			<div className="login">
				...
				<div className="content">
					<form className="login-form" action="index.html" method="post" onSubmit={handleSubmit(Submit)}>
