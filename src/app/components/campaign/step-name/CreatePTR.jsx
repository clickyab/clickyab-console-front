                ...
                <div className="portlet light bordered margin-top-20">
                    ...
                    <div className="portlet-title">
                        <div className="caption font-blue bold">
                            <i className="fa fa-bullseye font-blue"/> ثبت کمپین جدید </div>
                    </div>
                            ...
                            <div className="simform-inner">
                                <ol className="questions">
                                    <li className="current form-group">
                                        ...
                                        <Field autoFocus onFocus={() => {}} component="input" id="campaign_name" name="name" type="text"/>

                                    </li>
                                </ol>
                                <button className="btn-campaign-name submit btn btn-info  button-next btn-arrow-text" type="submit">مرحله بعد <i className="fa fa-angle-left"/></button>
