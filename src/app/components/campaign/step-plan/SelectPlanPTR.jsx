                    ...
                    <div className="price-column-container border-active">
                        ...
                        <div className="price-table-footer">
                            <button onClick={this.onSelectPlan(PlanList.items[key].id ,PlanList.items[key].name )}
                                    type="button" className="btn green-haze btn-outline sbold uppercase price-button plan-select-btn">
                                انتخاب
                            </button>
                        </div>
                    </div>
                        ...
                        <div className="margin-top-40">
                            <div className="pricing-content-1">
                                ...
                                <button onClick={this.sendPlan.bind(this)}
                                        className="btn btn-info  button-next btn-arrow-text margin-top-40 next-step" type="submit" disabled={!this.state.nextSubmit}>مرحله بعد <i className="fa fa-angle-left"/></button>
                                </div>
                            </div>
                        </div>
                    </div>
