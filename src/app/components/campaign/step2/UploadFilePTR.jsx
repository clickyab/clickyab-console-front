...
export default class UploadFilePTR extends Component {

    componentDidMount() {
        let {headerToken, UploadFile} = this.props;
        (function () {
            var r = new Flow({
            ...
            r.on('fileSuccess', function(file,message){
                var $self = $('.flow-file-'+file.uniqueIdentifier);
                //upload with swagger test
                UploadFile('http://www.eliteshepherds.com/sitebuildercontent/sitebuilderpictures/webassets/Hi.jpg');
